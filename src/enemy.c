...
void move_boss2_1_dead(int e) {
  ...
  quick_cloud(CLOUD_CIRCLE2, enemy[e].x + grand(170000) - grand(170000),
              enemy[e].y + grand(150000) - grand(150000),
              enemy[e].x_speed + grand(1000) - grand(1000),
              enemy[e].y_speed + grand(1000) - grand(1000), 30 + grand(30),
              CLOUD_COL_3, 960);
  if ((arena.counter & 7) == 7 && grand(4) == 0)
    play_effectwfvx(WAV_BANG1, 600 + grand(200), 180,
                    enemy[e].x + grand(170000) - grand(170000));
...
void run_boss1_1(int e) {
  ...
  if (boss.phase_count <= 0) {
    ...
    case 0: // entering
      ...
      enemy[e].angle =
          get_e_angle(e, enemy[e].x_target[0], enemy[e].y_target[0]);
      break;
  ...
  aim_at_target(e, enemy[e].x - 76000, enemy[e].y - 11000, player.x, player.y,
                5, 0);
  aim_at_target(e, enemy[e].x + 76000, enemy[e].y - 11000, player.x, player.y,
                5, 1);

  //   quick_cloud(CLOUD_CIRCLE2, enemy[e].x - 53000, enemy[e].y + 50000,
  //   enemy[e].x_speed, enemy[e].y_speed + 4000 + grand(4000), 15 + grand(10),
  //   CLOUD_COL_1, 980); quick_cloud(CLOUD_CIRCLE2, enemy[e].x + 53000,
  //   enemy[e].y + 50000, enemy[e].x_speed, enemy[e].y_speed + 4000 +
  //   grand(4000), 15 + grand(10), CLOUD_COL_1, 980);
  ...
  case 1: // attack 1  - both red
    if (boss.recycle <= 0) {
      boss1_1_fire1(e, enemy[e].x - 76000, enemy[e].y - 11000,
                    enemy[e].aim[0] + grand(24) - grand(24));
      boss.recycle = 4 + coin() DIFF 1;
    }
    if (boss.recycle2 <= 0) {
      boss1_1_fire1(e, enemy[e].x + 76000, enemy[e].y - 11000,
                    enemy[e].aim[1] + grand(24) - grand(24));
...
void boss1_1_fire1(int e, int x, int y, int a) {
  ...
  if (b != -1) {
    ...
    ebullet[b].angle =
        radians_to_angle(atan2(ebullet[b].y_speed, ebullet[b].x_speed));
    ebullet[b].timeout = 4000;
    ebullet[b].colour = CLOUD_COL_1;
    quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y, ebullet[b].x_speed,
                ebullet[b].y_speed, 20 + grand(10), CLOUD_COL_1, 930);
...
void boss1_1_fire2(int e, int x, int y, int a) {
  ...
  if (b != -1) {
    ...
    ebullet[b].y = y;
    ebullet[b].x_speed =
        enemy[e].x_speed + xpart(a, 9500 + arena.difficulty * 500);
    ebullet[b].y_speed =
        enemy[e].y_speed + ypart(a, 9500 + arena.difficulty * 500);
    ebullet[b].angle =
        radians_to_angle(atan2(ebullet[b].y_speed, ebullet[b].x_speed));
    ebullet[b].timeout = 4000;
    ebullet[b].colour = CLOUD_COL_3;
    quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y, ebullet[b].x_speed,
                ebullet[b].y_speed, 30 + grand(10), CLOUD_COL_3, 900);
    for (i = 0; i < 4; i++) {
      angle = ebullet[b].angle + ANGLE_4 + grand(100);
      speed = 3000 + grand(1000);
      quick_cloud(CLOUD_FCIRCLE4, ebullet[b].x, ebullet[b].y,
                  ebullet[b].x_speed + xpart(angle, speed),
                  ebullet[b].y_speed + ypart(angle, speed), 30 + grand(10),
                  CLOUD_COL_3, 900);
      angle = ebullet[b].angle - ANGLE_4 - grand(100);
      speed = 3000 + grand(1000);
      quick_cloud(CLOUD_FCIRCLE4, ebullet[b].x, ebullet[b].y,
...
void run_boss1_2(int e) {
    ...
    if (boss.recycle3 <= 0) {
      ...
      for (i = 0; i < 32; i++) {
        ...
        if (b != -1) {
          ...
          ebullet[b].x_speed =
              enemy[e].x_speed + xpart(ebullet[b].angle, speed);
          ebullet[b].y_speed =
              enemy[e].y_speed + ypart(ebullet[b].angle, speed);
      ...
      /*    angle += ANGLE_3;
          for (i = 0; i < 32; i ++)
          {
               ...
               if (b != -1)
               {
                ...
                ebullet[b].angle = angle;
                speed = 1200;
                ebullet[b].x_speed = enemy[e].x_speed + xpart(ebullet[b].angle,
         speed); ebullet[b].y_speed = enemy[e].y_speed + ypart(ebullet[b].angle,
         speed); ebullet[b].x_speed += xpart(i * 128, 600); ebullet[b].y_speed
         += ypart(i * 128, 600); ebullet[b].timeout = 4000; ebullet[b].colour =
         CLOUD_COL_2; ebullet[b].status = 0;
               }
          }*/
      quick_cloud(CLOUD_FCIRCLE2, enemy[e].x, enemy[e].y + 41000,
                  enemy[e].x_speed, enemy[e].y_speed, 50 + grand(10),
                  CLOUD_COL_3, 950);
  ...
  case 1: // attack 1  - both red
    if (boss.recycle <= 0) {
      boss1_2_fire1(e, enemy[e].x - 76000, enemy[e].y - 11000,
                    enemy[e].aim[0] + grand(24) - grand(24));
...
void boss1_2_fire1(int e, int x, int y, int a) {
  ...
  if (b != -1) {
    ...
    ebullet[b].colour = CLOUD_COL_3;
    quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y, ebullet[b].x_speed,
                ebullet[b].y_speed, 20 + grand(10), CLOUD_COL_3, 930);
    ebullet[b].status = 6 + grand(5);
  }
  ...
  if (b != -1) {
    ...
    //          quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y,
    //          ebullet[b].x_speed, ebullet[b].y_speed, 20 + grand(10),
    //          CLOUD_COL_1, 930);
    ebullet[b].status = 6 + grand(5);
  }
  b = create_ebullet(EBULLET_SHOT);
...
void boss1_2_fire2(int e, int x, int y, int a) {
  ...
  for (i = 0; i < 4; i++) {
    ...
    if (b != -1) {
      ...
      if (i == 0)
        quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y,
                    ebullet[b].x_speed, ebullet[b].y_speed, 30 + grand(10),
                    CLOUD_COL_1, 930);
    }
  }
}
...
void run_boss1_3(int e) {
  ...
  if (boss.phase_count <= 0) {
    ...
    case 2:
      ...
      //    enemy[e].x_target [0] = RAND_X_IN;
      //    .enemy[e].y_target [0] = 120000 + grand(180000);
      //..    enemy[e].angle = get_e_angle(e, enemy[e].x_target [0],
      // enemy[e].y_target [0]);
      boss.phase2 = coin();
      break;
    case 3:
  ...
  //   aim_at_target(e, enemy[e].x - 76000, enemy[e].y - 11000, player.x,
  //   player.y, 7, 0); aim_at_target(e, enemy[e].x + 76000, enemy[e].y - 11000,
  ...
  if (boss.phase > 0) {
    ...
    if (boss.recycle3 <= 0) {
      ...
      case 0:
        ...
        if (b != -1) {
          if (coin()) {
            play_effectwfvx(WAV_INTER, 400 + grand(50), 190,
                            enemy[e].x - 99000);
            ebullet[b].x = enemy[e].x - 99000;
            angle = radians_to_angle(atan2(player.y - (enemy[e].y + 42000),
                                           player.x - (enemy[e].x - 99000)));
            quick_cloud(CLOUD_FCIRCLE2, enemy[e].x - 99000, enemy[e].y + 42000,
                        enemy[e].x_speed, enemy[e].y_speed, 50 + grand(10),
                        CLOUD_COL_3, 950);
          } else {
            play_effectwfvx(WAV_INTER, 400 + grand(50), 190,
  ...
  case 1: // attack 1  - both red
    ...
    if (boss.recycle <= 0) {
      if (boss.side == 0) {
        boss1_3_fire1(e, enemy[e].x - 76000, enemy[e].y - 11000,
                      enemy[e].aim[0]);
        boss.side = 1;
      } else {
        boss1_3_fire1(e, enemy[e].x + 76000, enemy[e].y - 11000,
...
void boss1_3_fire1(int e, int x, int y, int a) {
  ...
  if (b != -1) {
    ...
    ebullet[b].colour = CLOUD_COL_1;
    quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y, ebullet[b].x_speed,
                ebullet[b].y_speed, 40 + grand(10), CLOUD_COL_1, 930);
...
void boss1_3_fire2(int e) {
  ...
  if (enemy[e].recycle <= 0) {
    ...
    //       enemy[e].angle1 = delta_turn_towards_xy(enemy[e].x, enemy[e].y,
    //       player.x, player.y, enemy[e].aim [enemy[e].status], 1);
...
void run_boss2_1(int e) {
  ...
  aim_at_target(e, enemy[e].x - 90000, enemy[e].y + 27000, player.x, player.y,
                7, 0);
  aim_at_target(e, enemy[e].x + 90000, enemy[e].y + 27000, player.x, player.y,
                7, 1);

  aim_at_target(e, enemy[e].x - 50000, enemy[e].y - 13000, player.x, player.y,
                7, 2);
  aim_at_target(e, enemy[e].x + 50000, enemy[e].y - 13000, player.x, player.y,
                7, 3);
  ...
  case 1: // attack 1
    if (boss.recycle <= 0) {
      boss2_1_fire1(e, enemy[e].x - 90000, enemy[e].y + 27000,
                    enemy[e].aim[0] + grand(24) - grand(24));
      boss.recycle = 32 DIFF 8;
    }
    if (boss.recycle2 <= 0) {
  ...
  case 2: // attack 2
    if (boss.recycle <= 0) {
      boss2_1_fire2(e, enemy[e].x - 90000, enemy[e].y + 27000,
                    enemy[e].aim[0] + grand(24) - grand(24));
      boss.recycle = 32 DIFF 8;
    }
    if (boss.recycle2 <= 0) {
  ...
  case 3: // attack 3 - red left, right blue
    if (boss.recycle <= 0) {
      boss2_1_fire3(e, enemy[e].x - 90000, enemy[e].y + 27000,
                    enemy[e].aim[0] + grand(24) - grand(24));
  ...
  case 4: // attack 4 - reverse 3
    if (boss.recycle <= 0) {
      boss2_1_fire4(e, enemy[e].x - 90000, enemy[e].y + 27000,
                    enemy[e].aim[0] + grand(24) - grand(24));
      boss.recycle = 32 DIFF 8;
    }
    if (boss.recycle2 <= 0) {
  ...
  case 1: // attack 1
    if (boss.recycle4 <= 0) {
      boss2_1_fire1(e, enemy[e].x - 50000, enemy[e].y - 27000,
                    enemy[e].aim[2] + grand(24) - grand(24));
      boss.recycle4 = 32 DIFF 8;
    }
    if (boss.recycle3 <= 0) {
      boss2_1_fire1(e, enemy[e].x + 50000, enemy[e].y - 27000,
                    enemy[e].aim[3] + grand(24) - grand(24));
      boss.recycle3 = 32 DIFF 8;
    }
    break;
  case 2: // attack 2
    if (boss.recycle4 <= 0) {
      boss2_1_fire2(e, enemy[e].x - 50000, enemy[e].y - 27000,
                    enemy[e].aim[2] + grand(24) - grand(24));
      boss.recycle4 = 32 DIFF 8;
    }
    if (boss.recycle3 <= 0) {
  ...
  case 3: // attack 3 - red left, right blue
    if (boss.recycle4 <= 0) {
      boss2_1_fire3(e, enemy[e].x - 50000, enemy[e].y - 27000,
                    enemy[e].aim[2] + grand(24) - grand(24));
  ...
  case 4: // attack 4 - reverse 3
    if (boss.recycle4 <= 0) {
      boss2_1_fire4(e, enemy[e].x - 50000, enemy[e].y - 27000,
                    enemy[e].aim[2] + grand(24) - grand(24));
      boss.recycle4 = 32 DIFF 8;
    }
    if (boss.recycle3 <= 0) {
...
void boss2_1_fire2(int e, int x, int y, int a) {
  ...
  if (b != -1) {
    ...
    //          ebullet[b].angle = radians_to_angle(atan2(ebullet[b].y_speed,
    //          ebullet[b].x_speed));
    ebullet[b].timeout = 4000;
    ebullet[b].colour = CLOUD_COL_4;
    quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y, ebullet[b].x_speed,
                ebullet[b].y_speed, 40 + grand(10), CLOUD_COL_4, 930);
...
void boss2_1_fire3(int e, int x, int y, int a) {
  ...
  if (b != -1)
    quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y, ebullet[b].x_speed,
                ebullet[b].y_speed, 40 + grand(10), CLOUD_COL_3, 930);
  // can be any bullet.
}
...
void boss2_1_fire4(int e, int x, int y, int a) {
  ...
  if (b != -1) {
    ...
    ebullet[b].colour = CLOUD_COL_2;
    quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y, ebullet[b].x_speed,
                ebullet[b].y_speed, 40 + grand(10), CLOUD_COL_2, 930);
...
void run_boss2_2(int e) {
      ...
      for (i = 0; i < 5; i++) {
        ...
        if (b != -1) {
          ...
          if (enemy[e].burst == 5)
            ebullet[b].status = 14;
          ebullet[b].x_speed =
              enemy[e].x_speed + xpart(ebullet[b].angle + i * ANGLE_5,
                                       2000 + ebullet[b].status * 200);
          ebullet[b].y_speed =
              enemy[e].y_speed + ypart(ebullet[b].angle + i * ANGLE_5,
                                       2000 + ebullet[b].status * 200);
          quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y,
                      ebullet[b].x_speed, ebullet[b].y_speed, 30 + grand(10),
                      CLOUD_COL_3, 950);
      ...
      if (enemy[e].recycle <= 0) {
        ...
        for (i = 0; i < 3; i++) {
          ...
          if (b != -1) {
            ...
            ebullet[b].status = 9;
            ebullet[b].x_speed =
                enemy[e].x_speed + xpart(ebullet[b].angle + i * ANGLE_3, 3500);
            ebullet[b].y_speed =
                enemy[e].y_speed + ypart(ebullet[b].angle + i * ANGLE_3, 3500);
            quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y,
                        ebullet[b].x_speed, ebullet[b].y_speed, 30 + grand(10),
                        CLOUD_COL_3, 950);
          }
          ...
          if (b != -1) {
            ...
            ebullet[b].status = 7;
            ebullet[b].x_speed =
                enemy[e].x_speed + xpart(ebullet[b].angle + i * ANGLE_3, 3200);
            ebullet[b].y_speed =
                enemy[e].y_speed + ypart(ebullet[b].angle + i * ANGLE_3, 3200);
            quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y,
                        ebullet[b].x_speed, ebullet[b].y_speed, 30 + grand(10),
                        CLOUD_COL_1, 950);
          }
  ...
  case 4:
    ...
    /*  case 2: // attack 2
       if (boss.recycle4 <= 0)
       {
        boss2_1_fire2(e, enemy[e].x - 50000, enemy[e].y - 27000, enemy[e].aim
      [2] + grand(24) - grand(24)); boss.recycle4 = 32 DIFF 8;
       }
       if (boss.recycle3 <= 0)
       {
        boss2_1_fire2(e, enemy[e].x + 50000, enemy[e].y - 27000, enemy[e].aim
      [3] + grand(24) - grand(24)); boss.recycle3 = 32 DIFF 8;
       }
       break;
      case 3: // attack 3 - red left, right blue
       if (boss.recycle4 <= 0)
       {
        boss2_1_fire3(e, enemy[e].x - 50000, enemy[e].y - 27000, enemy[e].aim
      [2] + grand(24) - grand(24)); boss.recycle4 = 62 DIFF 12;
       }
       if (boss.recycle3 <= 0)
       {
        boss2_1_fire3(e, enemy[e].x + 50000, enemy[e].y - 27000, enemy[e].aim
      [3] + grand(24) - grand(24)); boss.recycle3 = 62 DIFF 12;
       }
       break;
      case 4: // attack 4 - reverse 3
       if (boss.recycle4 <= 0)
       {
        boss2_1_fire4(e, enemy[e].x - 50000, enemy[e].y - 27000, enemy[e].aim
      [2] + grand(24) - grand(24)); boss.recycle4 = 32 DIFF 8;
       }
       if (boss.recycle3 <= 0)
       {
...
void run_boss3_1(int e) {
  ...
  //   aim_at_target(e, enemy[e].x - 76000, enemy[e].y - 11000, player.x,
  //   player.y, 5, 0); aim_at_target(e, enemy[e].x + 76000, enemy[e].y - 11000,
  ...
  aim_at_target(e, enemy[e].x - 106000, enemy[e].y + 65000, player.x, player.y,
                8, 0);
  aim_at_target(e, enemy[e].x + 106000, enemy[e].y + 65000, player.x, player.y,
                8, 1);
    ...
    if (boss.recycle <= 0 && enemy[e].x_speed == 0 && enemy[e].y_speed == 0) {
      ...
      for (i = 0; i < 5; i++) {
        ...
        if (b != -1) {
          ...
          ebullet[b].x_speed =
              xpart(ebullet[b].angle, 5000 + arena.difficulty * 1000);
          ebullet[b].y_speed =
              ypart(ebullet[b].angle, 5000 + arena.difficulty * 1000);
          ebullet[b].x = enemy[e].x - 56300 + xpart(ebullet[b].angle, 10000);
          ebullet[b].y = enemy[e].y + 7000 + ypart(ebullet[b].angle, 10000);
          ebullet[b].timeout = 4000;
          ebullet[b].colour = CLOUD_COL_1;
          quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y, 0, 0,
                      30 + grand(10), CLOUD_COL_1, 950);
  ...
  case 4: // third attack - random blobs
    ...
    /*  case 1: // attack 1  - both red
       if (boss.recycle <= 0)
       {
        boss1_1_fire1(e, enemy[e].x - 76000, enemy[e].y - 11000, enemy[e].aim
      [0] + grand(24) - grand(24)); boss.recycle = 4 + coin() DIFF 1;
       }
       if (boss.recycle2 <= 0)
       {
        boss1_1_fire1(e, enemy[e].x + 76000, enemy[e].y - 11000, enemy[e].aim
      [1] + grand(24) - grand(24)); boss.recycle2 = 4 + coin() DIFF 1;
       }
       break;
      case 2: // attack 2 - both blue
       if (boss.recycle <= 0)
       {
        boss1_1_fire2(e, enemy[e].x - 76000, enemy[e].y - 11000, enemy[e].aim
      [0]); boss.recycle = 30 DIFF 7;
       }
       if (boss.recycle2 <= 0)
       {
        boss1_1_fire2(e, enemy[e].x + 76000, enemy[e].y - 11000, enemy[e].aim
      [1]); boss.recycle2 = 30 DIFF 7;
       }
       break;
      case 3: // attack 3 - red left, right blue
       if (boss.recycle <= 0)
  ...
  case 1: // attack 1
    if (boss.recycle2 <= 0) {
      ...
      boss3_1_fire1(e, enemy[e].x - 108544, enemy[e].y + 66560,
                    enemy[e].aim[0]);
      boss3_1_fire1(e, enemy[e].x + 108544, enemy[e].y + 66560,
                    enemy[e].aim[1]);
  ...
  case 2: // attack 2
    if (boss.recycle2 <= 0) {
      ...
      boss3_1_fire2(e, enemy[e].x - 108544, enemy[e].y + 66560,
                    enemy[e].aim[0]);
      boss3_1_fire2(e, enemy[e].x + 108544, enemy[e].y + 66560,
                    enemy[e].aim[1]);
  ...
  case 3: // attack 3
    if (boss.recycle2 <= 0) {
      ...
      boss3_1_fire3(e, enemy[e].x - 108544, enemy[e].y + 66560,
                    enemy[e].aim[0]);
      boss3_1_fire3(e, enemy[e].x + 108544, enemy[e].y + 66560,
                    enemy[e].aim[1]);
  ...
  if (boss.phase > 1) {
    ...
    //    if (arena.counter
    /*    enemy[e].angle = get_e_angle(e, enemy[e].x_target [0],
    enemy[e].y_target [0]); enemy[e].x_speed += xpart(enemy[e].angle, 110);
        enemy[e].y_speed += ypart(enemy[e].angle, 110);
        if (enemy[e].x > enemy[e].x_target [0] - 20000
         && enemy[e].x < enemy[e].x_target [0] + 20000
         && enemy[e].y > enemy[e].y_target [0] - 20000
...
void run_boss3_2(int e) {
  ...
  aim_at_target(e, enemy[e].x - 79872, enemy[e].y + 8192, player.x, player.y, 8,
                0);
  aim_at_target(e, enemy[e].x + 79872, enemy[e].y + 8192, player.x, player.y, 8,
                1);
  ...
  case 1: // moving
    ...
    if (boss.recycle <= 0) {
      ...
      quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, enemy[e].x_speed,
                  enemy[e].y_speed, 30 + grand(16), CLOUD_COL_4, 0);
      boss.recycle = 5 DIFF 1;
    }
    break;
  case 2: // triple attack
    if (boss.recycle <= 0 && enemy[e].x_speed == 0 && enemy[e].y_speed == 0) {
      ...
      for (i = 0; i < 9; i++) {
        ...
        if (b != -1) {
          ...
          ebullet[b].x_speed =
              xpart(ebullet[b].angle, 7000 + arena.difficulty * 500);
          ebullet[b].y_speed =
              ypart(ebullet[b].angle, 7000 + arena.difficulty * 500);
...
void run_boss3_0(int e) {
  ...
  //   aim_at_target(e, enemy[e].x - 106000, enemy[e].y + 65000, player.x,
  //   player.y, 8, 0); aim_at_target(e, enemy[e].x + 106000, enemy[e].y +
  //   65000, player.x, player.y, 8, 1);
...
void move_dswooper(int e) {
  ...
  if (enemy[e].x_target[enemy[e].target] != -1 && enemy[e].y < 470000) {
    track_target(e, enemy[e].x_target[enemy[e].target],
                 enemy[e].y_target[enemy[e].target], enemy[e].angle1,
                 eclass[enemy[e].type].speed2);
    enemy[e].angle1 &= 1023;
  }
...
void move_dancer(int e) {
  ...
  if (enemy[e].recycle > 0)
    enemy[e].recycle--;
  if (enemy[e].recycle <= 0) {
    if (enemy[e].y > 3000 && enemy[e].x > 3000 && enemy[e].x < 597000 &&
        enemy[e].y < 590000) {
      ready_to_fire = 1;
    }
  }
  ...
  case ENEMY_FIGHTER4:
    ...
    if (enemy[e].recycle <= 0 && ready_to_fire == 1) {
      ...
      if (b != -1) {
        ...
        ebullet[b].colour = CLOUD_COL_3;
        quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y,
                    enemy[e].x_speed, enemy[e].y_speed, 30 + grand(10),
                    CLOUD_COL_3, 975);
        for (i = 0; i < 4; i++) {
          angle = ebullet[b].angle + ANGLE_4 + grand(100);
          speed = 3000 + grand(1000);
          quick_cloud(CLOUD_FCIRCLE4, ebullet[b].x, ebullet[b].y,
                      enemy[e].x_speed + xpart(angle, speed),
                      enemy[e].y_speed + ypart(angle, speed), 30 + grand(10),
                      CLOUD_COL_3, 940);
          angle = ebullet[b].angle - ANGLE_4 - grand(100);
          speed = 3000 + grand(1000);
          quick_cloud(CLOUD_FCIRCLE4, ebullet[b].x, ebullet[b].y,
  ...
  case ENEMY_FIGHTER7:
    ...
    if (enemy[e].recycle <= 0 && ready_to_fire == 1) {
      ...
      if (b != -1) {
        ...
        ebullet[b].timeout = 4000;
        ebullet[b].colour = CLOUD_COL_4;
        quick_cloud(CLOUD_FCIRCLE1, ebullet[b].x, ebullet[b].y,
                    enemy[e].x_speed, enemy[e].y_speed, 25 + grand(5),
                    CLOUD_COL_3, 900);
      }
      b = create_ebullet(EBULLET_SPINNER3);
      if (b != -1) {
  ...
  case ENEMY_FIGHTER8:
    ...
    if (enemy[e].recycle <= 0 && ready_to_fire == 1) {
      ...
      if (b != -1) {
        ...
        ebullet[b].x_speed =
            enemy[e].x_speed +
            xpart(ebullet[b].angle, 9000); // xpart(ebullet[b].angle, 7000);
        ebullet[b].y_speed =
            enemy[e].y_speed +
            ypart(ebullet[b].angle, 9000); // ypart(ebullet[b].angle, 7000);
        ebullet[b].angle =
            radians_to_angle(atan2(ebullet[b].y_speed, ebullet[b].x_speed));
  ...
  case ENEMY_FIGHTER6:
    if (enemy[e].recycle <= 0 && ready_to_fire == 1) {
      ...
      if (b != -1) {
        ...
        angle = radians_to_angle(
            atan2(player.y - (enemy[e].y), player.x - (enemy[e].x)));
        quick_cloud(CLOUD_FCIRCLE1, enemy[e].x, enemy[e].y, enemy[e].x_speed,
                    enemy[e].y_speed, 25 + grand(5), CLOUD_COL_3, 950);
        speed = 3200;
        ebullet[b].x_speed = xpart(angle, speed); // + enemy[e].x_speed;
        ebullet[b].y_speed = ypart(angle, speed); // + enemy[e].y_speed;
        ebullet[b].timeout = 4000;                // important!
  ...
  case ENEMY_FIGHTER:
    ...
    if (enemy[e].status > 0) {
      if (enemy[e].status & 1) {
        quick_cloud(CLOUD_FCIRCLE4, enemy[e].x, enemy[e].y, enemy[e].x_speed,
                    enemy[e].y_speed, 10 + grand(10) + enemy[e].status,
                    CLOUD_COL_2, 992);
      }
      enemy[e].status--;
    }
  ...
  case ENEMY_FIGHTER2:
    ...
    if (enemy[e].recycle <= 0 && ready_to_fire == 1) {
      ...
      if (b != -1) {
        ...
        ebullet[b].status = 0;
        quick_cloud(CLOUD_FCIRCLE4, ebullet[b].x, ebullet[b].y,
                    enemy[e].x_speed, enemy[e].y_speed, 40 + grand(10),
                    CLOUD_COL_2, 950);
      }
      enemy[e].burst--;
      if (enemy[e].burst <= 0) {
  ...
  case ENEMY_FIGHTER3:
    ...
    if (enemy[e].recycle <= 0 && ready_to_fire == 1) {
      ...
      if (b != -1) {
        ...
        ebullet[b].timeout = 4000;
        ebullet[b].colour = CLOUD_COL_2;
        //          quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y, 0,
        //          0, 30 + grand(10), CLOUD_COL_2, 950);
  ...
  switch (enemy[e].type) {
  case ENEMY_FIGHTER:
    //      quick_cloud(CLOUD_CIRCLE5, enemy[e].x, enemy[e].y + 12000,
    //      enemy[e].x_speed, enemy[e].y_speed + 2000 + grand(1000), 10 +
    //      grand(10), CLOUD_COL_1, 0);
    break;
  }
...
void petal_turn(int e, int p, int target_angle, int accel, int max_speed)
{
 ...
 if ((enemy[e].petal_angle [p] < target_angle && target_angle >
enemy[e].petal_angle [p] + ANGLE_2)
     || (enemy[e].petal_angle [p] > target_angle && target_angle >
enemy[e].petal_angle [p] - ANGLE_2))
 {
    ...
    case ENEMY_MACHINE3:
      if (enemy[e].recycle <= 0) {
        ...
        if (b != -1) {
          ...
          ebullet[b].angle = enemy[e].angle1;
          ebullet[b].x_speed =
              xpart(ebullet[b].angle,
                    10000 + arena.difficulty * 1000 - enemy[e].burst * 1000);
          ebullet[b].y_speed =
              ypart(ebullet[b].angle,
                    10000 + arena.difficulty * 1000 - enemy[e].burst * 1000);
          ebullet[b].timeout = 4000;
          ebullet[b].colour = CLOUD_COL_2;
          quick_cloud(CLOUD_FCIRCLE2, ebullet[b].x, ebullet[b].y, 0, 0,
                      40 + grand(16), CLOUD_COL_2, 950);
          if (e & 1)
...
void move_dart_stopper(int e) {
  ...
  case 0: // entry
    ...
    if (enemy[e].x > enemy[e].x_target[0] - 40000 &&
        ...
        enemy[e].y < enemy[e].y_target[0] + 40000) {
      enemy[e].angle =
          get_e_angle(e, enemy[e].x_target[1], enemy[e].y_target[1]);
      enemy[e].phase = 1;
      enemy[e].persist = 0;
    }
    break;
  ...
  case 2: // firing!
    ...
    default:
      if (enemy[e].recycle == 0) {
        /*           fire_wing_diamond(enemy[e].x, enemy[e].y, grand(ANGLE_1),
           EBCOL_B2, 20, 15 + arena.difficulty * 5); if (arena.difficulty > 0)
                    fire_wing_diamond(enemy[e].x, enemy[e].y, grand(ANGLE_1),
           EBCOL_B2, 20, 15 + arena.difficulty * 5); if (arena.difficulty > 1)
                    fire_wing_diamond(enemy[e].x, enemy[e].y, grand(ANGLE_1),
           EBCOL_B2, 20, 15 + arena.difficulty * 5);
        */
    ...
    /*     for (i = 0; i < 4; i ++)
         {
           ...
           if ((enemy[e].petal_angle [i] > tangle - 20
            ...
            || (tangle > ANGLE_1 - 20 && enemy[e].petal_angle [i] < ANGLE_1 -
       tangle))
            {
...
void move_drifter(int e) {
  ...
  if (enemy[e].target_time <= 0) {
    ...
    switch (grand(4)) {
    case 0:
      enemy[e].x_target[0] = -100000;
      break;
    case 1:
      enemy[e].x_target[0] = 900000;
      break;
    case 2:
      enemy[e].y_target[0] = -100000;
      break;
    case 3:
      enemy[e].y_target[0] = 900000;
      break;
    }
    enemy[e].angle = get_e_angle(e, enemy[e].x_target[0], enemy[e].y_target[0]);
  }
  ...
  case 0:
    if ((enemy[e].x > enemy[e].x_target[0] - 40000 &&
      ...
      if (enemy[e].escorting != -1) {
        enemy[e].x_target[0] = enemy[enemy[e].escorting].x + grand(60000) -
                               grand(60000) + enemy[e].pulse1;
        enemy[e].y_target[0] = enemy[enemy[e].escorting].y + grand(60000) -
                               grand(60000) + enemy[e].pulse2;
        enemy[e].angle =
            get_e_angle(e, enemy[e].x_target[0], enemy[e].y_target[0]);
      } else {
        enemy[e].x_target[0] = RAND_X_IN;
  ...
  default:
    if (enemy[e].status > 0)
      enemy[e].status--;
    if (enemy[e].recycle <= 0 && enemy[e].phase == 0 && enemy[e].y < 440000) {
      angle = attack_angle(e);
      //           fire_dot(enemy[e].x, enemy[e].y, angle, EBCOL_B3, 5, 4000 +
      //           arena.difficulty * 1000, 7);
      enemy[e].recycle = 65 - arena.difficulty * 10;
      enemy[e].status = 16;
    }
    //      quick_cloud(CLOUD_CIRCLE2, enemy[e].x, enemy[e].y + 15000 +
    //      (enemy[e].type == ENEMY_DRIFTER1) * 4000, enemy[e].x_speed +
    //      grand(300) - grand(300), enemy[e].y_speed + 1500 + grand(2500), 6 +
    //      grand(4), TCOL_SH2, 0);
    break;
  }
}
  ...
  switch (enemy[e].type) {
    /*  case ENEMY_SPINNER:
          if (enemy[e].recycle <= 0)
          {
           if (synch_ready [EVENT_FIRE4_1])
           {
            ...
            angle = radians_to_angle(atan2(player.y - enemy[e].y - 32000,
       player.x - enemy[e].x)); fire_ddart(enemy[e].x, enemy[e].y + 32000,
       angle, EBCOL_B5, 40, 90 + arena.difficulty * 10); angle =
       radians_to_angle(atan2(player.y - enemy[e].y + 32000, player.x -
       enemy[e].x)); fire_ddart(enemy[e].x, enemy[e].y - 32000, angle, EBCOL_B5,
       40, 90 + arena.difficulty * 10);
           }
          }
    ...
    */
    ...
    /*  if ((arena.counter & 1) == 0)
      {
        quick_cloud(CLOUD_CIRCLE2, enemy[e].x + 14000, enemy[e].y + 49000,
      grand(300) - grand(300), 3500 + grand(2500), 6 + grand(6), TCOL_ORANGE,
      0); quick_cloud(CLOUD_CIRCLE2, enemy[e].x - 14000, enemy[e].y + 49000,
      grand(300) - grand(300), 3500 + grand(2500), 6 + grand(6), TCOL_ORANGE,
      0);
      }
       else
       {
        quick_cloud(CLOUD_CIRCLE2, enemy[e].x + 14000, enemy[e].y + 49000,
      grand(300) - grand(300), 3500 + grand(2500), 12 + grand(12), TCOL_SH2, 0);
        quick_cloud(CLOUD_CIRCLE2, enemy[e].x - 14000, enemy[e].y + 49000,
      grand(300) - grand(300), 3500 + grand(2500), 12 + grand(12), TCOL_SH2, 0);
       }*/
  default:
    if (enemy[e].status == 0)
      track_target(e, player.x, player.y, enemy[e].angle1,
                   5 + arena.difficulty * 3);
    if (enemy[e].status > 0) {
      //       fire_beam(e, 25000);
      enemy[e].status--;
...
void move_stopper(int e) {
  ...
  if (enemy[e].target_time <= 0) {
    ...
    case 1:               // opening
      ...
      break;
    case 2: // shooting
      if ((enemy[e].type == ENEMY_MEDIUM || enemy[e].type == ENEMY_RISER) &&
          enemy[e].burst > 0) {
        enemy[e].target_time++;
        break;
      }
  ...
  case ENEMY_DOME3:
    ...
    if (enemy[e].y < 500000 && enemy[e].recycle <= 0) {
      ...
      for (i = -2; i < 3; i++) {
        ...
        if (b != -1) {
          ebullet[b].x =
              enemy[e].x + xpart(enemy[e].angle + (xa + i) * ANGLE_10, 19000);
          ebullet[b].y = enemy[e].y +
                         ypart(enemy[e].angle + (xa + i) * ANGLE_10, 19000) -
                         19000;
          ebullet[b].angle = angle;
  ...
  case ENEMY_RISER:
    ...
    break;
  case ENEMY_BIG3:
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 77000, enemy[e].y + 16000,
                enemy[e].x_speed, enemy[e].y_speed + 4000 + grand(4000),
                5 + grand(4), CLOUD_COL_1, 980);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 77000, enemy[e].y + 16000,
                enemy[e].x_speed, enemy[e].y_speed + 4000 + grand(4000),
                5 + grand(4), CLOUD_COL_1, 980);
    if (enemy[e].recycle <= 0) {
      ...
      for (j = 0; j < 3; j++) {
        ...
        for (i = 0; i < 12; i++) {
          ...
          if (b != -1) {
            ...
            ebullet[b].x_speed =
                enemy[e].x_speed + xpart(angle, speed) +
                xpart(angle_inc, 1200 + xpart(angle2 * 2, 200));
            ebullet[b].y_speed =
                enemy[e].y_speed + ypart(angle, speed) +
                ypart(angle_inc, 1200 + xpart(angle2 * 2, 200));

            //          ebullet[b].x_speed = enemy[e].x_speed + xpart(angle,
            //          speed) + xpart(angle_inc, 1200 + xpart(angle2 * 4,
            //          400)); ebullet[b].y_speed = enemy[e].y_speed +
            //          ypart(angle, speed) + ypart(angle_inc, 1200 +
            //          xpart(angle2 * 4, 400)); ebullet[b].x_speed += xpart(i *
            //          128, 1200); ebullet[b].y_speed += ypart(i * 128, 1200);
            ebullet[b].timeout = 4000;
            ebullet[b].colour = CLOUD_COL_3;
            ebullet[b].status = 0;
          }
        ...
        for (i = 0; i < 9; i++) {
          ...
          if (b != -1) {
            ...
            speed = 2500;
            ebullet[b].x_speed = enemy[e].x_speed + xpart(angle, speed) +
                                 xpart(angle_inc, 800 + xpart(angle2 * 2, 100));
            ebullet[b].y_speed = enemy[e].y_speed + ypart(angle, speed) +
                                 ypart(angle_inc, 800 + xpart(angle2 * 2, 100));
            ebullet[b].timeout = 4000;
            ebullet[b].colour = 1;
            ebullet[b].status = 3;
          }
      ...
      quick_cloud(CLOUD_FCIRCLE2, enemy[e].x, enemy[e].y - 25000,
                  enemy[e].x_speed, enemy[e].y_speed, 40 + grand(10),
                  CLOUD_COL_3, 950);
  ...
  case ENEMY_DOUBLE3:
    if (enemy[e].status == 1 || enemy[e].burst <= 0)
      aim_at_target(e, enemy[e].x - 19000, enemy[e].y - 10000, player.x,
                    player.y, 7, 0);
    if (enemy[e].status == 0 || enemy[e].burst <= 0)
      aim_at_target(e, enemy[e].x + 19000, enemy[e].y - 10000, player.x,
                    player.y, 7, 1);
  ...
  case ENEMY_DOUBLE4:
    if (enemy[e].burst <= 0)
      aim_at_target(e, enemy[e].x - 69000, enemy[e].y + 19000, player.x,
                    player.y, 9, 0);
    if (enemy[e].burst <= 0)
      aim_at_target(e, enemy[e].x + 69000, enemy[e].y + 19000, player.x,
                    player.y, 9, 1);
  ...
  case ENEMY_BIG2:
    quick_cloud(CLOUD_CIRCLE2, enemy[e].x, enemy[e].y + 95000, enemy[e].x_speed,
                enemy[e].y_speed + 4000 + grand(4000), 15 + grand(10),
                CLOUD_COL_1, 980);
    ...
    break;
  case ENEMY_DOUBLE:
    aim_at_target(e, enemy[e].x - 21000, enemy[e].y + 10000, player.x, player.y,
                  4, 0);
    aim_at_target(e, enemy[e].x + 21000, enemy[e].y + 10000, player.x, player.y,
                  4, 1);
    if (enemy[e].recycle <= 0) {
      ...
      if (b != -1) {
        if (enemy[e].status == 0) {
          ebullet[b].x =
              enemy[e].x - 21504 + xpart(enemy[e].aim[enemy[e].status], 5000);
          ebullet[b].y =
              enemy[e].y + 10240 + ypart(enemy[e].aim[enemy[e].status], 5000);
        } else {
          ebullet[b].x =
              enemy[e].x + 21504 + xpart(enemy[e].aim[enemy[e].status], 5000);
          ebullet[b].y =
  ...
  case ENEMY_WIDE:
    ...
    if (enemy[e].recycle <= 0) {
      ...
      quick_cloud(CLOUD_CIRCLE1_2, enemy[e].x, enemy[e].y, enemy[e].x_speed,
                  enemy[e].y_speed, 10 + grand(10), CLOUD_COL_4, 0);
  ...
  case ENEMY_DOME:
    if (enemy[e].recycle <= 0) {
      if (enemy[e].phase == 4) {
        quick_cloud(CLOUD_SMALL_SHOCK, enemy[e].x, enemy[e].y, 0,
                    enemy[e].y_speed, 30, CLOUD_COL_3, 0);
        quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, 0, enemy[e].y_speed,
                    30 + grand(16), CLOUD_COL_3, 0);
        angle = grand(ANGLE_1);
        for (i = 0; i < 5; i++) {
          angle += ANGLE_5;
          ...
          if (b != -1) {
            ...
            ebullet[b].x_speed = enemy[e].x_speed + xpart(angle, speed);
            ebullet[b].y_speed = enemy[e].y_speed + ypart(angle, speed);
            //            if (abs(ebullet[b].y_speed) + abs(ebullet[b].y_speed)
            //            < 100)
      ...
      //       speed = angle;
               ...
               for (i = 0; i < 21; i ++)
               {
                ...
                if (b != -1)
                {
                 ...
                 ebullet[b].y = enemy[e].y;
                 ebullet[b].angle = angle;
      //           ebullet[b].x_speed = xpart(angle, 3000) + xpart(angle + 30,
      xpart(speed, 1500));
      //           ebullet[b].y_speed = ypart(angle, 3000) + ypart(angle + 30,
      xpart(speed, 1500)); ebullet[b].x_speed = xpart(angle, 1000 +
      abs(ypart(speed, 3500))); ebullet[b].y_speed = ypart(angle, 1000 +
      abs(ypart(speed, 3500))); ebullet[b].timeout = 4000; ebullet[b].status =
      5; ebullet[b].colour = CLOUD_COL_3;
                }
...
void move_enemy(int e) {
  ...
  /*
       if (enemy[e].y > Y_MAX
        ...
        enemy[e].y_speed *= -1;
  */
  // the edge collision should take account of enemy size, but it doesn't for
  // now.
}
/*
...
int fire_diamond(int x, int y, int angle, int colour, int speed, int rot, int
wait)
{
 int b = create_ebullet(EBULLET_SHOT2);
 if (b != -1)
...
int fire_curve(int x, int y, int angle, int colour, int speed, int rot, int
wait)
{
...
int fire_beam(int e, int dist)
{
 ...
 if (b != -1)
 {
  ...
  if (enemy[e].status > 100 || enemy[e].status < 20)
  {
   ...
   {
    ebullet[b].x = enemy[e].x + xpart(enemy[e].angle1, dist + 4000 -
(enemy[e].status % 6) * GRAIN * 4); ebullet[b].y = enemy[e].y +
ypart(enemy[e].angle1, dist + 4000 - (enemy[e].status % 6) * GRAIN * 4);
   }
...
int fire_beam2(int e, int angle, int dist, int time)
{
 ...
 if (b != -1)
 {
  ...
  if (enemy[e].status > 100 || enemy[e].status < 20)
  {
   ...
   {
    ebullet[b].x = enemy[e].x + xpart(enemy[e].angle1, dist + 4000 -
((enemy[e].status * 2) % 12) * GRAIN * 4); ebullet[b].y = enemy[e].y +
ypart(enemy[e].angle1, dist + 4000 - ((enemy[e].status * 2) % 12) * GRAIN * 4);
   }
  ebullet[b].status = length;
  ebullet[b].angle = angle;
  ebullet[b].sprite_angle = angle / (ANGLE_1 / SMALL_ROTATIONS);
...
void aim_at_target(int e, int x, int y, int tx, int ty, int turn, int aiming) {
  ...
  int angle_move = delta_turn_towards_xy(x, y, tx, ty, enemy[e].aim[aiming], 1);
...
void track_target(int e, int x, int y, int angle, int turn) {
  ...
  int angle_move =
      delta_turn_towards_xy(enemy[e].x, enemy[e].y, x, y, angle, 1);

  //      textprintf_ex(screen, font, 5, 5, COLOUR_11, COLOUR_2, "%i %i %i %i %i
  //      %i    ", e, enemy[w] [e].type, enemy[w] [e].x, enemy[w] [e].y, turn,
  //      angle_move);
...
int pbullet_hits_enemy(int b, int e) {
  ...
  //  if (rel_y < 2000)
  //   rel_y = 2000;
    int dam = (pbullet[b].dam + (pbullet[b].dam * hypot(rel_y, rel_x) / 200)) /
  160; hurt_enemy(e, dam, pbullet[b].source);
  //  player.score = dam;
    return;
   }*/
...
void enemy_explode(int e) {
  ...
  case ENEMY_DOUBLE:
    ...
    quick_cloud(CLOUD_LARGE_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 40,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y - 8000, 0, 0,
                50 + grand(26), CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 25000, enemy[e].y + 25000, 0, 0, 40,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 25000, enemy[e].y + 25000, 0, 0, 40,
                CLOUD_COL_1, 0);
    ...
    for (i = 0; i < 10; i++) {
      ...
      angle = grand(ANGLE_1);
      xa = 15000 + grand(5400);
      quick_cloud(CLOUD_CIRCLE4, enemy[e].x + xpart(angle, xa),
                  enemy[e].y + ypart(angle, xa), xpart(angle, xa / 15),
                  ypart(angle, xa / 15), 80 + grand(26), CLOUD_COL_1, 960);

      // angle = grand(ANGLE_1);
      // xa = 20000 + grand(10000);
      // quick_cloud(CLOUD_CIRCLE4, enemy[e].x + xpart(angle, xa), enemy[e].y +
      // ypart(angle, xa), 0, 0, 40 + grand(30), CLOUD_COL_1, 0);

      angle = grand(ANGLE_1);
      xa = 4000 + grand(5400);
      quick_cloud(CLOUD_FCIRCLE2, enemy[e].x + xpart(angle, 5000),
                  enemy[e].y + ypart(angle, 5000), xpart(angle, xa),
                  ypart(angle, xa), 40 + grand(10), CLOUD_COL_1, 980);
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x + xpart(angle, 5000),
                  enemy[e].y + ypart(angle, 5000), xpart(angle, xa - 1000),
                  ypart(angle, xa - 1000), 35 + grand(10), CLOUD_COL_1, 980);
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x + xpart(angle, 5000),
                  enemy[e].y + ypart(angle, 5000), xpart(angle, xa - 2000),
                  ypart(angle, xa - 2000), 30 + grand(10), CLOUD_COL_1, 980);
    }
  ...
  case ENEMY_BOSS3_1:
    ...
    quick_cloud(CLOUD_LARGE_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 50,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, 0, 0, 70, CLOUD_COL_4,
                0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 106000, enemy[e].y + 65000, 0, 0,
                70, CLOUD_COL_4, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 106000, enemy[e].y + 65000, 0, 0,
                70, CLOUD_COL_4, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 55000, enemy[e].y + 7000, 0, 0, 70,
                CLOUD_COL_4, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 55000, enemy[e].y + 7000, 0, 0, 70,
                CLOUD_COL_4, 0);

    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 45000, enemy[e].y - 40000, 0, 0, 60,
                CLOUD_COL_4, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 45000, enemy[e].y - 40000, 0, 0, 60,
                CLOUD_COL_4, 0);

    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 100000, enemy[e].y + 5000, 0, 0, 60,
                CLOUD_COL_4, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 100000, enemy[e].y + 5000, 0, 0, 60,
                CLOUD_COL_4, 0);
    ...
    for (i = 0; i < 15; i++) {
      ...
      angle = grand(ANGLE_1);
      xa = 25000 + grand(5400);
      quick_cloud(CLOUD_CIRCLE4, enemy[e].x + xpart(angle, xa * 2),
                  enemy[e].y + ypart(angle, xa), xpart(angle, xa / 10),
                  ypart(angle, xa / 10), 80 + grand(26), CLOUD_COL_4, 960);
      ...
      angle = grand(ANGLE_1);
      xa = 5000 + grand(5400);
      quick_cloud(CLOUD_FCIRCLE2, enemy[e].x + xpart(angle, 38000),
                  enemy[e].y + ypart(angle, 25000), xpart(angle, xa),
                  ypart(angle, xa), 60 + grand(30), CLOUD_COL_4, 980);
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x + xpart(angle, 38000),
                  enemy[e].y + ypart(angle, 25000), xpart(angle, xa - 1000),
                  ypart(angle, xa - 1000), 50 + grand(30), CLOUD_COL_4, 980);
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x + xpart(angle, 38000),
                  enemy[e].y + ypart(angle, 25000), xpart(angle, xa - 2000),
                  ypart(angle, xa - 2000), 40 + grand(30), CLOUD_COL_4, 980);
    }
  ...
  case ENEMY_BOSS3_0:
    ...
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, 0, 0, 70, CLOUD_COL_4,
                0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 90000, enemy[e].y - 46000, 0, 0, 70,
                CLOUD_COL_4, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 90000, enemy[e].y - 46000, 0, 0, 70,
                CLOUD_COL_4, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 47000, enemy[e].y - 86000, 0, 0, 70,
                CLOUD_COL_4, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 47000, enemy[e].y - 86000, 0, 0, 70,
                CLOUD_COL_4, 0);

    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 80000, enemy[e].y + 51000, 0, 0, 60,
                CLOUD_COL_4, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 80000, enemy[e].y + 51000, 0, 0, 60,
                CLOUD_COL_4, 0);

    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 30000, enemy[e].y + 69000, 0, 0, 60,
                CLOUD_COL_4, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 30000, enemy[e].y + 69000, 0, 0, 60,
                CLOUD_COL_4, 0);
  ...
  case ENEMY_DOUBLE4:
    ...
    quick_cloud(CLOUD_HUGE_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 40, CLOUD_COL_1,
                0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, 0, 0, 80 + grand(16),
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 85000, enemy[e].y + 15000, 2000, 0,
                50 + grand(16), CLOUD_COL_1, 960);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 85000, enemy[e].y + 15000, -2000, 0,
                50 + grand(16), CLOUD_COL_1, 960);

    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 25000, enemy[e].y - 45000, 1000,
                1000, 50 + grand(16), CLOUD_COL_1, 950);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 25000, enemy[e].y - 45000, -1000,
                1000, 50 + grand(16), CLOUD_COL_1, 950);

    //      quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y + 45000, 0, 0, 50
    //      + grand(16), CLOUD_COL_1, 950);

    for (i = 0; i < 9; i++) {
      angle2 = grand(ANGLE_1);
      j = 2900 + grand(2000);
      xa = 30000 + grand(30000);
      c = quick_cloud(CLOUD_WAITCIRCLE4, enemy[e].x + xpart(angle2, xa * 2),
                      enemy[e].y + ypart(angle2, xa), xpart(angle2, j),
                      ypart(angle2, j), 36 + grand(50), CLOUD_COL_1, 980);
      if (c != -1)
  ...
  case ENEMY_BIG4:
    ...
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, 0, 0, 80 + grand(16),
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 45000, enemy[e].y - 25000, 0, 0,
                50 + grand(16), CLOUD_COL_1, 950);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 45000, enemy[e].y - 25000, 0, 0,
                50 + grand(16), CLOUD_COL_1, 950);

    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 35000, enemy[e].y + 35000, 0, 0,
                50 + grand(16), CLOUD_COL_1, 950);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 35000, enemy[e].y + 35000, 0, 0,
                50 + grand(16), CLOUD_COL_1, 950);

    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y + 45000, 0, 0,
                50 + grand(16), CLOUD_COL_1, 950);
    ...
    for (i = 0; i < 9; i++) {
      ...
      j = 2900 + grand(2000);
      xa = 30000 + grand(30000);
      c = quick_cloud(CLOUD_WAITCIRCLE4, enemy[e].x + xpart(angle2, xa),
                      enemy[e].y + ypart(angle2, xa), xpart(angle2, j),
                      ypart(angle2, j), 36 + grand(50), CLOUD_COL_1, 980);
      if (c != -1)
        cloud[c].status = 20 + grand(15);
  ...
  case ENEMY_DOME3:
    ...
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, 0, 0, 80 + grand(16),
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 22000, enemy[e].y + 42000, 0, 0,
                50 + grand(16), CLOUD_COL_1, 950);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 22000, enemy[e].y + 42000, 0, 0,
                50 + grand(16), CLOUD_COL_1, 950);
    ...
    for (i = 0; i < 7; i++) {
      ...
      c = quick_cloud(CLOUD_WAITCIRCLE4, enemy[e].x + xpart(angle2, xa),
                      enemy[e].y + ypart(angle2, xa), xpart(angle2, j),
                      ypart(angle2, j), 30 + grand(40), CLOUD_COL_1, 980);
      if (c != -1)
        cloud[c].status = 20 + grand(15);
      j = 200 + grand(3500);
      xa = 15000 + grand(20000);
  ...
  case ENEMY_WIDE:
    ...
    quick_cloud(CLOUD_LARGE_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 40,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, 0, 0, 50 + grand(16),
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 25000, enemy[e].y, 700, 0,
                50 + grand(16), CLOUD_COL_1, 950);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 50000, enemy[e].y, 1400, 0,
                50 + grand(16), CLOUD_COL_1, 950);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 75000, enemy[e].y, 2100, 0,
                50 + grand(16), CLOUD_COL_1, 950);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 25000, enemy[e].y, -700, 0,
                50 + grand(16), CLOUD_COL_1, 950);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 50000, enemy[e].y, -1400, 0,
  ...
  case ENEMY_FIGHTER7:
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 27000, enemy[e].y, 1500, 0,
                25 + grand(16), CLOUD_COL_1, 990);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 27000, enemy[e].y, -1500, 0,
                25 + grand(16), CLOUD_COL_1, 990);
    // fall through...
  case ENEMY_FIGHTER8:
    play_effectwfvx(WAV_BANG1, 500 + grand(200), 240, enemy[e].x);
    quick_cloud(CLOUD_SMALL_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 30,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, 0, 0, 40 + grand(16),
                CLOUD_COL_1, 0);
    for (i = 0; i < 5; i++) {
      angle2 = grand(ANGLE_1);
      j = 1000 + grand(1500);
      ...
      c = quick_cloud(CLOUD_WAITCIRCLE4, enemy[e].x + xpart(angle2, xa),
                      enemy[e].y + ypart(angle2, xa), xpart(angle2, j),
                      ypart(angle2, j), 20 + grand(40), CLOUD_COL_1, 980);
      if (c != -1)
  ...
  case ENEMY_MACHINE3:
    ...
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, 0, 0, 50 + grand(16),
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE2, enemy[e].x - 25000, enemy[e].y + 19000, 0, 0,
                50 + grand(16), CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE2, enemy[e].x + 25000, enemy[e].y + 19000, 0, 0,
                50 + grand(16), CLOUD_COL_1, 0);
    for (i = 0; i < 7; i++) {
      angle2 = grand(ANGLE_1);
      ...
      c = quick_cloud(CLOUD_WAITCIRCLE4, enemy[e].x + xpart(angle2, xa),
                      enemy[e].y + ypart(angle2, xa), xpart(angle2, j),
                      ypart(angle2, j), 26 + grand(50), CLOUD_COL_1, 980);
      if (c != -1)
    ...
    /*      angle = grand(ANGLE_1);
          for (i = 0; i < 4; i ++)
          {
           ...
           {
            c = quick_cloud(CLOUD_WAITCIRCLE4, enemy[e].x + xpart(angle2, xa),
       enemy[e].y + ypart(angle2, xa), xpart(angle2, 2000), ypart(angle2, 2000),
       66 + grand(20) - j * 8, CLOUD_COL_1, 800); if (c != -1) cloud[c].status =
       10 + grand(5) + j * 2; xa += 15000 + grand(4000); angle2 += grand(36) -
       grand(36); angle2 &= 1023;
           }
           angle += ANGLE_4;
          }*/
  ...
  case ENEMY_MACHINE2:
  case ENEMY_RISER:
    quick_cloud(CLOUD_CIRCLE2, enemy[e].x - 40000, enemy[e].y + 15000, 0, 0,
                50 + grand(16), CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE2, enemy[e].x + 40000, enemy[e].y + 15000, 0, 0,
                50 + grand(16), CLOUD_COL_1, 0);
    // fall through...
  case ENEMY_MACHINE:
    ...
    for (i = 0; i < 5; i++) {
      ...
      quick_cloud(CLOUD_CIRCLE4, enemy[e].x + xpart(angle, xa),
                  enemy[e].y + ypart(angle, xa), xpart(angle, xa / 15),
                  ypart(angle, xa / 15), 50 + grand(26), CLOUD_COL_1, 960);
    }
    quick_cloud(CLOUD_LARGE_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 40,
                CLOUD_COL_1, 0);
    //      quick_cloud(CLOUD_SMALL_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 30,
    ...
    for (i = 0; i < 15; i++) {
      angle = grand(ANGLE_1);
      xa = 4000 + grand(5400);
      quick_cloud(CLOUD_FCIRCLE2, enemy[e].x, enemy[e].y, xpart(angle, xa),
                  ypart(angle, xa), 30 + grand(10), CLOUD_COL_1,
                  970 + grand(5));
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x, enemy[e].y,
                  xpart(angle, xa - 1000), ypart(angle, xa - 1000),
                  30 + grand(10), CLOUD_COL_1, 975 + grand(5));
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x, enemy[e].y,
                  xpart(angle, xa - 2000), ypart(angle, xa - 2000),
                  25 + grand(10), CLOUD_COL_1, 977 + grand(5));
    }
    break;
  case ENEMY_MEDIUM:
    ...
    for (i = 0; i < 5; i++) {
      ...
      quick_cloud(CLOUD_CIRCLE4, enemy[e].x + xpart(angle, xa),
                  enemy[e].y + ypart(angle, xa), xpart(angle, xa / 15),
                  ypart(angle, xa / 15), 40 + grand(26), CLOUD_COL_1, 960);
    }
    quick_cloud(CLOUD_SMALL_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 30,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, 0, 0, 40 + grand(16),
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 10000, enemy[e].y - 25000, 0, 0,
                30 + grand(10), CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 10000, enemy[e].y - 25000, 0, 0,
                30 + grand(10), CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 19000, enemy[e].y + 15000, 0, 0,
                30 + grand(10), CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 19000, enemy[e].y + 15000, 0, 0,
                30 + grand(10), CLOUD_COL_1, 0);
    for (i = 0; i < 10; i++) {
      ...
      xa = 2000 + grand(5400);
      quick_cloud(CLOUD_FCIRCLE2, enemy[e].x, enemy[e].y, xpart(angle, xa),
                  ypart(angle, xa), 30 + grand(10), CLOUD_COL_1, 980);
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x, enemy[e].y,
                  xpart(angle, xa - 1000), ypart(angle, xa - 1000),
                  30 + grand(10), CLOUD_COL_1, 980);
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x, enemy[e].y,
                  xpart(angle, xa - 2000), ypart(angle, xa - 2000),
                  25 + grand(10), CLOUD_COL_1, 980);
    }
    break;
  case ENEMY_FIGHTER3:
  case ENEMY_FIGHTER5:
  ...
  case ENEMY_FIGHTER4:
    ...
    quick_cloud(CLOUD_SMALL_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 30,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, 0, 0, 30 + grand(16),
                CLOUD_COL_1, 0);
    for (i = 0; i < 10; i++) {
      // angle = grand(ANGLE_1);
      // xa = 20000 + grand(10000);
    ...
    /*      quick_cloud(CLOUD_SMALL_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 30,
       CLOUD_COL_3, 0); quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y, 0, 0,
       30 + grand(16), CLOUD_COL_3, 0); for (i = 0; i < 10; i ++)
          {
           //angle = grand(ANGLE_1);
           //xa = 20000 + grand(10000);
           //quick_cloud(CLOUD_CIRCLE4, enemy[e].x + xpart(angle, xa),
       enemy[e].y + ypart(angle, xa), 0, 0, 40 + grand(30), CLOUD_COL_1, 0);

           angle = grand(ANGLE_1);
           xa = 2000 + grand(5400);
           quick_cloud(CLOUD_FCIRCLE2, enemy[e].x, enemy[e].y, xpart(angle, xa),
       ypart(angle, xa), 30 + grand(10), CLOUD_COL_3, 980);
           quick_cloud(CLOUD_FCIRCLE4, enemy[e].x, enemy[e].y, xpart(angle, xa -
       1000), ypart(angle, xa - 1000), 30 + grand(10), CLOUD_COL_3, 980);
           quick_cloud(CLOUD_FCIRCLE4, enemy[e].x, enemy[e].y, xpart(angle, xa -
       2000), ypart(angle, xa - 2000), 25 + grand(10), CLOUD_COL_3, 980);
          }*/
    break;

  case ENEMY_DOUBLE3:
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 71000, enemy[e].y + 22000, 0, 0,
                40 + grand(10), CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 71000, enemy[e].y + 22000, 0, 0,
                40 + grand(10), CLOUD_COL_1, 0);
    // fall through...
  case ENEMY_DOUBLE2:
    ...
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 35000, enemy[e].y - 5000, 0, 0, 40,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 35000, enemy[e].y - 5000, 0, 0, 40,
                CLOUD_COL_1, 0);

    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 18000, enemy[e].y + 57000, 0, 0, 40,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 18000, enemy[e].y + 57000, 0, 0, 40,
                CLOUD_COL_1, 0);
    ...
    for (i = 0; i < 10; i++) {
      ...
      xa = 15000 + grand(5400);
      quick_cloud(CLOUD_CIRCLE4, enemy[e].x + xpart(angle, xa * 2),
                  enemy[e].y + ypart(angle, xa), xpart(angle, xa / 8),
                  ypart(angle, xa / 19), 80 + grand(26), CLOUD_COL_1, 960);
      ...
      angle = grand(ANGLE_1);
      xa = 4000 + grand(5400);
      quick_cloud(CLOUD_FCIRCLE2, enemy[e].x + xpart(angle, 9000),
                  enemy[e].y + ypart(angle, 4000), xpart(angle, (xa * 2)),
                  ypart(angle, xa), 40 + grand(10), CLOUD_COL_1,
                  950 + grand(5));
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x + xpart(angle, 9000),
                  enemy[e].y + ypart(angle, 4000),
                  xpart(angle, (xa * 2) - 1000), ypart(angle, xa - 1000),
                  35 + grand(10), CLOUD_COL_1, 956 + grand(5));
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x + xpart(angle, 9000),
                  enemy[e].y + ypart(angle, 4000),
                  xpart(angle, (xa * 2) - 2000), ypart(angle, xa - 2000),
                  30 + grand(10), CLOUD_COL_1, 961 + grand(5));
    }
  ...
  case ENEMY_DOME2:
    ...
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y - 8000, 0, 0,
                50 + grand(26), CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 25000, enemy[e].y, 0, 0, 40,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 25000, enemy[e].y, 0, 0, 40,
                CLOUD_COL_1, 0);

    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y - 65000, 0, 0, 40,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y + 15000, 0, 0, 40,
                CLOUD_COL_1, 0);
  ...
  case ENEMY_BIG:
    ...
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 35000, enemy[e].y + 55000, 0, 0, 40,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 35000, enemy[e].y + 55000, 0, 0, 40,
                CLOUD_COL_1, 0);
    ...
    break;
  case ENEMY_BIG3:
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 81000, enemy[e].y - 8000, 0, 0, 40,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 81000, enemy[e].y - 8000, 0, 0, 40,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_SMALL_SHOCK, enemy[e].x - 81000, enemy[e].y - 8000, 0, 0,
                30, CLOUD_COL_1, 0);
    quick_cloud(CLOUD_SMALL_SHOCK, enemy[e].x + 81000, enemy[e].y - 8000, 0, 0,
                30, CLOUD_COL_1, 0);
  case ENEMY_BIG2:
    ...
    quick_cloud(CLOUD_HUGE_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 40, CLOUD_COL_1,
                0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y - 8000, 0, 0,
                60 + grand(26), CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 25000, enemy[e].y + 25000, 0, 0, 40,
                CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 25000, enemy[e].y + 25000, 0, 0, 40,
                CLOUD_COL_1, 0);

    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y + 55000, 0, 0,
                50 + grand(10), CLOUD_COL_1, 0);

    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 65000, enemy[e].y + 70000, 0, 0,
                50 + grand(10), CLOUD_COL_1, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 65000, enemy[e].y + 70000, 0, 0,
                50 + grand(10), CLOUD_COL_1, 0);
    ...
    for (i = 0; i < 20; i++) {
      ...
      angle = grand(ANGLE_1);
      xa = 35000 + grand(8400);
      quick_cloud(CLOUD_CIRCLE2, enemy[e].x + xpart(angle, xa),
                  enemy[e].y + ypart(angle, xa), xpart(angle, xa / 15),
                  ypart(angle, xa / 15), 80 + grand(26), CLOUD_COL_1, 960);
      ...
      angle = grand(ANGLE_1);
      xa = 4000 + grand(5400);
      quick_cloud(CLOUD_FCIRCLE2, enemy[e].x + xpart(angle, 45000),
                  enemy[e].y + ypart(angle, 45000), xpart(angle, xa),
                  ypart(angle, xa), 40 + grand(10), CLOUD_COL_1,
                  970 + grand(5));
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x + xpart(angle, 45000),
                  enemy[e].y + ypart(angle, 45000), xpart(angle, xa - 1000),
                  ypart(angle, xa - 1000), 35 + grand(10), CLOUD_COL_1,
                  975 + grand(5));
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x + xpart(angle, 45000),
                  enemy[e].y + ypart(angle, 45000), xpart(angle, xa - 2000),
                  ypart(angle, xa - 2000), 30 + grand(10), CLOUD_COL_1,
                  980 + grand(5));
    }
  ...
  case ENEMY_BOSS1_3:
    ...
    //      quick_cloud(CLOUD_HUGE_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 40,
    //      CLOUD_COL_2, 0);
    quick_cloud(CLOUD_HUGE_SHOCK, enemy[e].x - 76000, enemy[e].y - 11000, 0, 0,
                40, CLOUD_COL_2, 0);
    quick_cloud(CLOUD_HUGE_SHOCK, enemy[e].x + 76000, enemy[e].y - 11000, 0, 0,
                40, CLOUD_COL_2, 0);

    c = quick_cloud(CLOUD_RUMBLE, enemy[e].x, enemy[e].y, 0, 0, 75, CLOUD_COL_2,
                    0);
    if (c != -1) {
      cloud[c].status = 31;
    ...
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 125000, enemy[e].y - 11000, 0, 0,
                40, CLOUD_COL_2, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 125000, enemy[e].y - 11000, 0, 0,
                40, CLOUD_COL_2, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 105000, enemy[e].y - 7000, 0, 0, 40,
                CLOUD_COL_2, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 105000, enemy[e].y - 7000, 0, 0, 40,
                CLOUD_COL_2, 0);

    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y + 55000, 0, 0,
                50 + grand(10), CLOUD_COL_2, 0);
    ...
    for (i = 0; i < 20; i++) {
      ...
      xa = 35000 + grand(8400);
      quick_cloud(CLOUD_CIRCLE2, enemy[e].x + xpart(angle, xa),
                  enemy[e].y + ypart(angle, xa), xpart(angle, xa / 7),
                  ypart(angle, xa / 15), 80 + grand(26), CLOUD_COL_2, 960);
      ...
      xa = 4000 + grand(5400);
      quick_cloud(CLOUD_FCIRCLE2, enemy[e].x + xpart(angle, 45000),
                  enemy[e].y + ypart(angle, 45000), xpart(angle, xa * 2),
                  ypart(angle, xa), 40 + grand(10), CLOUD_COL_2,
                  970 + grand(5));
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x + xpart(angle, 45000),
                  enemy[e].y + ypart(angle, 45000), xpart(angle, xa * 2 - 1000),
                  ypart(angle, xa - 1000), 35 + grand(10), CLOUD_COL_2,
                  975 + grand(5));
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x + xpart(angle, 45000),
                  enemy[e].y + ypart(angle, 45000), xpart(angle, xa * 2 - 2000),
                  ypart(angle, xa - 2000), 30 + grand(10), CLOUD_COL_2,
                  980 + grand(5));
    }
  ...
  case ENEMY_BOSS2_1:
    play_effectwfvx(WAV_BANG4, 350 + grand(80), 150, enemy[e].x);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 90000, enemy[e].y + 27000, 0, 0,
                40 + grand(15), CLOUD_COL_3, 0);
    quick_cloud(CLOUD_LARGE_SHOCK, enemy[e].x + 90000, enemy[e].y + 27000, 0, 0,
                40, CLOUD_COL_3, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 90000, enemy[e].y + 27000, 0, 0,
                40 + grand(15), CLOUD_COL_3, 0);
    quick_cloud(CLOUD_LARGE_SHOCK, enemy[e].x - 90000, enemy[e].y + 27000, 0, 0,
    ...
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 50000, enemy[e].y - 13000, 0, 0,
                40 + grand(15), CLOUD_COL_3, 0);
    quick_cloud(CLOUD_LARGE_SHOCK, enemy[e].x + 50000, enemy[e].y - 13000, 0, 0,
                40, CLOUD_COL_3, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 50000, enemy[e].y - 13000, 0, 0,
                40 + grand(15), CLOUD_COL_3, 0);
    quick_cloud(CLOUD_LARGE_SHOCK, enemy[e].x - 50000, enemy[e].y - 13000, 0, 0,
  ...
  case ENEMY_BOSS2_2:
    play_effectwfvx(WAV_BANG4, 350 + grand(80), 150, enemy[e].x);
    quick_cloud(CLOUD_HUGE_SHOCK, enemy[e].x, enemy[e].y, 0, 0, 40, CLOUD_COL_3,
                0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x, enemy[e].y - 8000, 0, 0,
                60 + grand(26), CLOUD_COL_3, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x - 25000, enemy[e].y + 25000, 0, 0, 40,
                CLOUD_COL_3, 0);
    quick_cloud(CLOUD_CIRCLE1, enemy[e].x + 25000, enemy[e].y + 25000, 0, 0, 40,
                CLOUD_COL_3, 0);

    c = quick_cloud(CLOUD_RUMBLE, enemy[e].x, enemy[e].y, 0, 0, 75, CLOUD_COL_3,
                    0);
    if (c != -1) {
      cloud[c].status = 31;
    ...
    for (i = 0; i < 20; i++) {
      ...
      quick_cloud(CLOUD_CIRCLE2, enemy[e].x + xpart(angle, xa),
                  enemy[e].y + ypart(angle, xa), xpart(angle, xa / 15),
                  ypart(angle, xa / 15), 80 + grand(26), CLOUD_COL_3, 960);
      ...
      quick_cloud(CLOUD_FCIRCLE2, enemy[e].x + xpart(angle, 45000),
                  enemy[e].y + ypart(angle, 45000), xpart(angle, xa),
                  ypart(angle, xa), 40 + grand(10), CLOUD_COL_3,
                  970 + grand(5));
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x + xpart(angle, 45000),
                  enemy[e].y + ypart(angle, 45000), xpart(angle, xa - 1000),
                  ypart(angle, xa - 1000), 35 + grand(10), CLOUD_COL_3,
                  975 + grand(5));
      quick_cloud(CLOUD_FCIRCLE4, enemy[e].x + xpart(angle, 45000),
                  enemy[e].y + ypart(angle, 45000), xpart(angle, xa - 2000),
                  ypart(angle, xa - 2000), 30 + grand(10), CLOUD_COL_3,
                  980 + grand(5));
    }
...
// this is ONLY for parts which explode because the parent has exploded. If the
// part is destroyed itself,
//  don't call this!
void part_explode(int e) {
...
void allocate_xp(int e) {
  ...
  // if (boss.fight && (enemy[e].type == ENEMY_SMALL || enemy[e].type ==
  // ENEMY_SMALL2))
  // return;
  ...
  // xp for parts allocated according to damage to main. Any damage to parts is
  // ignored (but becomes relevant
  ...
  for (i = 0; i < 3; i++) {
    ...
    if (player.wxp[i] >= LEVEL_CALC) {
      ...
      player.wgained[i] = 20;
      player.bflash[i] = 25;
      //   play_effectwfvx(WAV_LEVEL, tone[NOTE_1G + player.wlevel [i]], 200,
      //   player.x); play_effectwfvx(WAV_LEVEL, tone[NOTE_2G], 250, player.x);
    }
    set_wpixels();
  }
...
#define XAA grand(1000) - grand(1000)
    ...
    case PTYPE_BASIC:
      ...
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 8000, 0, 2000,
                  15 + grand(5), CLOUD_COL_1, 800);

      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 8000, 0, 12000,
                  25 + grand(5), CLOUD_COL_1, 900);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 8000, 0, 15000,
                  18 + grand(5), CLOUD_COL_1, 900);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 8000, 0, 10000,
                  18 + grand(5), CLOUD_COL_1, 900);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 8000, XAA, 9000,
                  15 + grand(5), CLOUD_COL_1, 900);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 8000, XAA, 8000,
                  12 + grand(5), CLOUD_COL_1, 900);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 8000, XAA, 7000,
                  11 + grand(4), CLOUD_COL_1, 890);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 8000, XAA, 6000,
                  10 + grand(4), CLOUD_COL_1, 880);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 8000, XAA, 5000,
                  9 + grand(4), CLOUD_COL_1, 870);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 8000, XAA, 4000,
                  8 + grand(4), CLOUD_COL_1, 860);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 8000, XAA, 3000,
                  7 + grand(4), CLOUD_COL_1, 850);
      break;
    case PTYPE_ANENOME:

      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 11000, 0, 2000,
                  15 + grand(5), CLOUD_COL_1, 800);

      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 11000, 0, 12000,
                  25 + grand(5), CLOUD_COL_1, 900);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 11000, 0, 15000,
                  18 + grand(5), CLOUD_COL_1, 900);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 11000, 0, 10000,
                  18 + grand(5), CLOUD_COL_1, 900);

      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 11000, 6000, 9000,
                  15 + grand(2), CLOUD_COL_1, 900);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 11000, 3500, 8000,
                  12 + grand(2), CLOUD_COL_1, 900);
      ...
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 11000, XAA, 7000,
                  11 + grand(4), CLOUD_COL_1, 890);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 11000, XAA, 6000,
                  10 + grand(4), CLOUD_COL_1, 880);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 11000, XAA, 5000,
                  9 + grand(4), CLOUD_COL_1, 870);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 11000, XAA, 4000,
                  8 + grand(4), CLOUD_COL_1, 860);
      quick_cloud(CLOUD_CIRCLE1, player.x, player.y + 11000, XAA, 3000,
                  7 + grand(4), CLOUD_COL_1, 850);
      break;

    case PTYPE_BOMBER:

      quick_cloud(CLOUD_CIRCLE1, player.x - 18000, player.y + 7000, 0, 15000,
                  20 + grand(5), CLOUD_COL_1, 840);
      quick_cloud(CLOUD_CIRCLE1, player.x - 18000, player.y + 7000, 0, 18000,
                  13 + grand(5), CLOUD_COL_1, 840);
      quick_cloud(CLOUD_CIRCLE1, player.x - 18000, player.y + 7000, 0, 12000,
                  13 + grand(5), CLOUD_COL_1, 840);

      quick_cloud(CLOUD_CIRCLE1, player.x - 18000, player.y + 7000, XAA, 9000,
                  9 + grand(4), CLOUD_COL_1, 840);
      quick_cloud(CLOUD_CIRCLE1, player.x - 18000, player.y + 7000, XAA, 8000,
                  8 + grand(4), CLOUD_COL_1, 830);
      quick_cloud(CLOUD_CIRCLE1, player.x - 18000, player.y + 7000, XAA, 7000,
                  7 + grand(4), CLOUD_COL_1, 820);
    ...
    case PTYPE_HAND:
      quick_cloud(CLOUD_CIRCLE1, player.x - 16000, player.y + 7000, -6000 + XAA,
                  10000, 20 + grand(5), CLOUD_COL_1, 840);
      quick_cloud(CLOUD_CIRCLE1, player.x - 16000, player.y + 7000, -8000 + XAA,
                  12000, 13 + grand(5), CLOUD_COL_1, 840);
      quick_cloud(CLOUD_CIRCLE1, player.x - 16000, player.y + 7000, -5000 + XAA,
                  8000, 13 + grand(5), CLOUD_COL_1, 840);

      quick_cloud(CLOUD_CIRCLE1, player.x - 16000, player.y + 7000, -4000 + XAA,
                  6000, 9 + grand(4), CLOUD_COL_1, 840);
      quick_cloud(CLOUD_CIRCLE1, player.x - 16000, player.y + 7000, -3500 + XAA,
                  5000, 8 + grand(4), CLOUD_COL_1, 830);
      quick_cloud(CLOUD_CIRCLE1, player.x - 16000, player.y + 7000, -3000 + XAA,
                  4000, 7 + grand(4), CLOUD_COL_1, 820);
    ...
    case PTYPE_SQUID:
      ...
      quick_cloud(CLOUD_CIRCLE1, player.x - 16000, player.y - 5000, -1000, 0,
                  10 + grand(3), CLOUD_COL_3, 800);

      quick_cloud(CLOUD_CIRCLE1, player.x - 16000, player.y - 5000, -10000, 0,
                  15 + grand(5), CLOUD_COL_3, 800);
      quick_cloud(CLOUD_CIRCLE1, player.x - 16000, player.y - 5000, -8000, 0,
                  13 + grand(5), CLOUD_COL_3, 770);
      quick_cloud(CLOUD_CIRCLE1, player.x - 16000, player.y - 5000, -6000, 0,
                  11 + grand(5), CLOUD_COL_3, 750);
      quick_cloud(CLOUD_CIRCLE1, player.x - 16000, player.y - 5000, -5000, 0,
                  9 + grand(5), CLOUD_COL_3, 720);
      quick_cloud(CLOUD_CIRCLE1, player.x - 16000, player.y - 5000, -4000, 0,
                  7 + grand(5), CLOUD_COL_3, 700);
...
void destroy_enemy(int e) { enemy[e].type = ENEMY_NONE; }
