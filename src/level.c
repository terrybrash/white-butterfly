...
int overtrack[4][91][10] = {
    {
        {T_EMPTY, T_EMPTY, T_EMPTY, 2, 2, 2, AP_NONE, AP_NONE, AP_NONE,
         30}, // doesn't appear
        //{T_CHANGE_MUSIC, OVERMUSIC_L1_2, 0, 0, 0},

        //{T_BOSS1_3, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
        //420},

        /*
        {T_RISER, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
        2420},
        //{T_CHANGE_MUSIC, OVERMUSIC_L1_2, 0, 0, 0, 0, 0, 0, 0, 0},
        {T_DOUBLE2, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
        420}, {T_DOUBLE2, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
        AP_NONE, 420},
        //{T_CHANGE_MUSIC, OVERMUSIC_L1_2, 0, 0, 0, 0, 0, 0, 0, 0},


        {T_DOUBLE3, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
        420},
        */
        /*
        {T_DOUBLE2, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
        220}, {T_DOUBLE2, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
        AP_NONE, 220}, {T_DOUBLE2, T_DOUBLE2, T_DOUBLE2, 1, 100, 200, AP_LEFT,
        AP_CENTRE, AP_RIGHT, 220},*/

        {T_PALETTE, PAL_BASE, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         2},
        /*
        //{T_END_LEVEL, T_EMPTY, T_EMPTY, 1, 1, 1, AP_NONE, AP_NONE, AP_NONE,
        80}, {T_FIGHTER, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
        AP_NONE, 220},

        {T_PALETTE, PAL_L1_2, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
        3}, {T_FIGHTER, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
        AP_NONE, 220},

        {T_PALETTE, PAL_L1_3, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
        3}, {T_FIGHTER, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
        AP_NONE, 220},

        {T_PALETTE, PAL_L2_1, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
        3}, {T_FIGHTER, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
        AP_NONE, 220},

        {T_PALETTE, PAL_L2_2, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
        3}, {T_FIGHTER, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
        AP_NONE, 220},
        */

        {T_FIGHTER, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_DOUBLE, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_DOUBLE, T_FIGHTER, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         420},
        {T_MACHINE, T_EMPTY, T_EMPTY, 1, 1, 2, AP_NONE, AP_NONE, AP_NONE, 130},
        {T_DOUBLE, T_MACHINE, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         320},

        {T_FIGHTER, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_DOUBLE, T_DOUBLE, T_EMPTY, 1, 1, 200, AP_LEFT, AP_RIGHT, AP_NONE,
         320},
        {T_FIGHTER, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_DOUBLE, T_DOUBLE, T_EMPTY, 1, 1, 200, AP_LEFT, AP_RIGHT, AP_NONE,
         320},
        {T_FIGHTER2, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_FIGHTER2, T_FIGHTER, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        ...
        {T_DOUBLE, T_DOUBLE, T_EMPTY, 1, 1, 200, AP_LEFT, AP_RIGHT, AP_NONE,
         320},
        {T_FIGHTER2, T_FIGHTER, T_FIGHTER, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 230},
        {T_FIGHTER2, T_MACHINE, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_DOME, T_DOME, T_FIGHTER2, 1, 1, 200, AP_LEFT, AP_RIGHT, AP_NONE,
         320},
        {T_DOUBLE, T_DOUBLE, T_EMPTY, 1, 1, 200, AP_LEFT, AP_RIGHT, AP_NONE,
         320},
        {T_FIGHTER, T_MACHINE, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_FIGHTER2, T_MACHINE, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         620},
        ...
        {T_FIGHTER2, T_FIGHTER, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_FIGHTER3, T_FIGHTER2, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 230},
        {T_FIGHTER3, T_MACHINE, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         420},
        {T_BIG2, T_FIGHTER, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         420},
        {T_FIGHTER3, T_MACHINE, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         320},
        {T_DOUBLE, T_FIGHTER, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
        ...
        {T_FIGHTER3, T_FIGHTER2, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 320},
        {T_DOUBLE, T_FIGHTER, T_MACHINE2, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 230},
        {T_FIGHTER2, T_FIGHTER, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         320},
        ...
        {T_FIGHTER3, T_MACHINE, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         420},
        {T_FIGHTER, T_MACHINE2, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_FIGHTER2, T_MACHINE2, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 320},
        {T_DOUBLE, T_DOUBLE, T_EMPTY, 1, 1, 200, AP_LEFT, AP_RIGHT, AP_NONE,
         320},
        {T_BIG2, T_FIGHTER, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
        ...
        {T_FIGHTER4, T_FIGHTER, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_DOUBLE, T_FIGHTER2, T_MACHINE2, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 230},
        {T_BIG2, T_FIGHTER, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         320},
        {T_FIGHTER4, T_DOUBLE2, T_EMPTY, 1, 100, 200, AP_NONE, AP_CENTRE,
         AP_NONE, 320},
        {T_DOUBLE, T_MACHINE, T_MACHINE2, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 420},
        {T_BIG2, T_DOME, T_DOME, 1, 160, 160, AP_CENTRE, AP_LEFT, AP_RIGHT,
         420},
        {T_FIGHTER2, T_FIGHTER3, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 320},
        {T_FIGHTER, T_FIGHTER2, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_FIGHTER, T_FIGHTER4, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_DOUBLE2, T_MACHINE, T_MACHINE2, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 320},
        {T_FIGHTER, T_FIGHTER2, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_FIGHTER, T_MACHINE, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_BIG2, T_FIGHTER4, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         230},
        {T_DOUBLE2, T_MACHINE, T_EMPTY, 1, 100, 200, AP_CENTRE, AP_NONE,
         AP_NONE, 230},
        {T_FIGHTER2, T_FIGHTER3, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 230},
        {T_FIGHTER, T_FIGHTER2, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
...

    {
        ...
        {T_DOUBLE2, T_DOUBLE2, T_EMPTY, 1, 1, 200, AP_LEFT, AP_RIGHT, AP_NONE,
         250},
        {T_FIGHTER5, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
        {T_FIGHTER4, T_FIGHTER5, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        {T_DOUBLE2, T_DOUBLE2, T_BIG2, 200, 200, 1, AP_LEFT, AP_RIGHT,
         AP_CENTRE, 350},
        {T_DOME2, T_FIGHTER5, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
        {T_FIGHTER, T_FIGHTER4, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         270},
        {T_MACHINE2, T_MACHINE2, T_MACHINE2, 1, 1, 1, AP_LEFT, AP_RIGHT,
         AP_CENTRE, 250},
        {T_MACHINE2, T_FIGHTER5, T_EMPTY, 1, 1, 200, AP_NONE, AP_NONE, AP_NONE,
         320},
        {T_FIGHTER5, T_BIG3, T_EMPTY, 1, 150, 1, AP_NONE, AP_CENTRE, AP_NONE,
         420},
        {T_RISER, T_EMPTY, T_EMPTY, 1, 1, 200, AP_NONE, AP_NONE, AP_NONE, 250},
        {T_DOUBLE2, T_DOUBLE2, T_RISER, 1, 1, 150, AP_LEFT, AP_RIGHT, AP_NONE,
         300},
        {T_MACHINE2, T_MACHINE2, T_MACHINE2, 1, 1, 1, AP_LEFT, AP_RIGHT,
         AP_CENTRE, 300},
        {T_MACHINE2, T_FIGHTER5, T_EMPTY, 1, 1, 200, AP_NONE, AP_NONE, AP_NONE,
         300},
        {T_FIGHTER4, T_DOME2, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
        {T_FIGHTER2, T_FIGHTER3, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        ...
        {T_MACHINE2, T_FIGHTER5, T_EMPTY, 1, 1, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
        {T_MEDIUM, T_EMPTY, T_EMPTY, 1, 1, 150, AP_NONE, AP_RIGHT, AP_NONE,
         400},
        ...
        {T_DOUBLE3, T_DOUBLE3, T_RISER, 1, 1, 150, AP_LEFT, AP_RIGHT, AP_NONE,
         320},
        {T_MACHINE2, T_FIGHTER6, T_EMPTY, 1, 1, 200, AP_NONE, AP_NONE, AP_NONE,
         260},
        {T_FIGHTER5, T_FIGHTER6, T_EMPTY, 1, 1, 200, AP_NONE, AP_NONE, AP_NONE,
         260},
        {T_MACHINE2, T_FIGHTER6, T_EMPTY, 1, 1, 200, AP_NONE, AP_NONE, AP_NONE,
         260},
        {T_DOUBLE3, T_EMPTY, T_EMPTY, 1, 1, 200, AP_CENTRE, AP_NONE, AP_NONE,
         260},
        {T_DOUBLE3, T_MEDIUM, T_EMPTY, 1, 100, 200, AP_CENTRE, AP_NONE, AP_NONE,
         260},
        {T_BIG3, T_RISER, T_EMPTY, 1, 1, 1, AP_CENTRE, AP_NONE, AP_NONE, 260},
        {T_FIGHTER5, T_FIGHTER6, T_EMPTY, 1, 150, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        {T_FIGHTER5, T_FIGHTER6, T_EMPTY, 1, 150, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        {T_FIGHTER5, T_FIGHTER6, T_EMPTY, 1, 150, 200, AP_NONE, AP_NONE,
         AP_NONE, 255},
        {T_DOUBLE3, T_DOUBLE3, T_BIG3, 1, 1, 100, AP_LEFT, AP_RIGHT, AP_CENTRE,
         250},
        {T_MACHINE2, T_FIGHTER6, T_EMPTY, 1, 1, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
        {T_FIGHTER5, T_FIGHTER6, T_EMPTY, 1, 1, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
        {T_MEDIUM, T_FIGHTER6, T_EMPTY, 1, 1, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
        {T_MEDIUM, T_EMPTY, T_EMPTY, 1, 1, 200, AP_NONE, AP_NONE, AP_NONE, 250},
        {T_DOUBLE3, T_EMPTY, T_EMPTY, 1, 1, 200, AP_CENTRE, AP_NONE, AP_NONE,
         250},
        {T_DOUBLE3, T_FIGHTER6, T_EMPTY, 1, 100, 200, AP_CENTRE, AP_NONE,
         AP_NONE, 250},
        {T_BIG3, T_RISER, T_EMPTY, 1, 1, 1, AP_CENTRE, AP_NONE, AP_NONE, 520},

        {T_BOSS2_2, T_EMPTY, T_EMPTY, 1, 1, 2, AP_CENTRE, AP_NONE, AP_NONE,
         330},
...

    {
        ...
        {T_PALETTE, PAL_L3_1, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         2},

        {T_FIGHTER7, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
        {T_FIGHTER7, T_FIGHTER7, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        {T_DOUBLE3, T_MEDIUM, T_EMPTY, 1, 100, 200, AP_CENTRE, AP_NONE, AP_NONE,
         350},
        {T_DOME3, T_DOME3, T_DOME3, 1, 1, 1, AP_LEFT, AP_RIGHT, AP_CENTRE, 250},
        {T_BIG3, T_RISER, T_EMPTY, 1, 1, 1, AP_CENTRE, AP_NONE, AP_NONE, 520},
        {T_FIGHTER7, T_FIGHTER6, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        {T_FIGHTER7, T_FIGHTER6, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        {T_DOME3, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
        {T_DOME3, T_FIGHTER8, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
        {T_FIGHTER7, T_FIGHTER8, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        {T_BIG4, T_DOUBLE3, T_DOUBLE3, 1, 61, 121, AP_LEFT, AP_RIGHT, AP_LEFT,
         422},
        {T_BIG4, T_FIGHTER8, T_FIGHTER8, 1, 61, 121, AP_RIGHT, AP_RIGHT,
         AP_LEFT, 322},
        {T_DOME3, T_DOME3, T_DOME3, 1, 1, 1, AP_LEFT, AP_RIGHT, AP_CENTRE, 250},
        {T_DOME3, T_FIGHTER8, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
        {T_FIGHTER8, T_FIGHTER8, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 550},

        {T_BOSS3_0, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         320},
        ...
        {T_FIGHTER7, T_FIGHTER8, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        {T_MEDIUM, T_EMPTY, T_EMPTY, 1, 100, 200, AP_CENTRE, AP_NONE, AP_NONE,
         250},
        {T_BIG4, T_DOUBLE3, T_DOUBLE3, 1, 61, 121, AP_CENTRE, AP_RIGHT, AP_LEFT,
         422},
        {T_FIGHTER7, T_FIGHTER7, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        {T_DOME3, T_FIGHTER8, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
        ...
        {T_FIGHTER7, T_FIGHTER6, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        {T_BIG4, T_BIG4, T_DOME3, 1, 61, 121, AP_LEFT, AP_RIGHT, AP_CENTRE,
         322},
        {T_MACHINE3, T_MACHINE3, T_MACHINE3, 1, 1, 1, AP_LEFT, AP_RIGHT,
         AP_CENTRE, 290},
        {T_MACHINE3, T_MACHINE3, T_MACHINE3, 1, 1, 1, AP_LEFT, AP_RIGHT,
         AP_CENTRE, 310},
        {T_DOME3, T_DOME3, T_DOME3, 1, 1, 1, AP_LEFT, AP_RIGHT, AP_CENTRE, 250},
        ...
        {T_FIGHTER7, T_FIGHTER6, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        {T_DOUBLE4, T_EMPTY, T_EMPTY, 1, 1, 200, AP_CENTRE, AP_RIGHT, AP_NONE,
         310},
        {T_BIG4, T_BIG4, T_DOME3, 1, 61, 121, AP_LEFT, AP_RIGHT, AP_CENTRE,
         422},
        {T_DOUBLE4, T_DOUBLE4, T_EMPTY, 1, 1, 200, AP_LEFT, AP_RIGHT, AP_NONE,
         610},

        {T_BOSS3_1, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         420},

        {T_PALETTE, PAL_L3_2, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         2},

        {T_MACHINE3, T_FIGHTER7, T_EMPTY, 1, 100, 1, AP_NONE, AP_RIGHT,
         AP_CENTRE, 250},
        {T_MACHINE3, T_FIGHTER6, T_EMPTY, 1, 100, 1, AP_NONE, AP_RIGHT,
         AP_CENTRE, 250},
        {T_MACHINE3, T_FIGHTER8, T_EMPTY, 1, 100, 1, AP_NONE, AP_RIGHT,
         AP_CENTRE, 250},
        {T_DOUBLE4, T_DOUBLE4, T_EMPTY, 1, 1, 200, AP_LEFT, AP_RIGHT, AP_NONE,
         240},
        {T_DOUBLE4, T_BIG4, T_EMPTY, 1, 1, 200, AP_CENTRE, AP_NONE, AP_NONE,
         240},
        {T_DOME3, T_DOME3, T_DOME3, 1, 1, 1, AP_LEFT, AP_RIGHT, AP_CENTRE, 250},
        {T_DOME3, T_FIGHTER8, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
        ...
        {T_MACHINE3, T_MACHINE3, T_EMPTY, 1, 100, 200, AP_LEFT, AP_RIGHT,
         AP_NONE, 250},
        {T_DOUBLE4, T_DOUBLE4, T_EMPTY, 1, 1, 200, AP_LEFT, AP_RIGHT, AP_NONE,
         310},
        {T_FIGHTER7, T_FIGHTER6, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE,
         AP_NONE, 250},
        {T_WIDE, T_DOUBLE4, T_FIGHTER6, 1, 1, 1, AP_CENTRE, AP_NONE, AP_NONE,
         150},
        {T_MACHINE3, T_MACHINE3, T_DOUBLE4, 1, 100, 200, AP_LEFT, AP_RIGHT,
         AP_NONE, 630},

        {T_BOSS3_2, T_EMPTY, T_EMPTY, 1, 100, 200, AP_NONE, AP_NONE, AP_NONE,
         250},
...
void run_level(void) { run_tracks(); }
...
void run_tracks(void) {
  ...
  if (boss.fight == 0) {
    ...
    if (next_track <= 0) {
      ...
      next_track =
          overtrack[arena.level - 1][overtrack_pos][OT_NEXT]; // see also above
    }
  }
...
int make_track(int t) {
  ...
  track[t].appear =
      overtrack[arena.level - 1][overtrack_pos][overtrack_pos2 + OT_AP];
  ...
  case T_FIGHTER:
    ...
    track[t].multiple = 4;
    track[t].count =
        overtrack[arena.level - 1][overtrack_pos][overtrack_pos2 + 3];
    track[t].count2 = 20;
  ...
  // track[t].count = grand(overtrack [arena.level - 1] [overtrack_pos] [3 +
  // t]);
  ...
  case TRACK_STOPPER:
    ...
    if (track[t].appear > 0)
      ...
      case AP_RANDOM:
        ...
        break;
      case AP_LEFT:
        track[t].x[1] = 50000 + grand(120000);
        break;
      case AP_RIGHT:
        track[t].x[1] = 564400 - grand(120000);
        break;
      case AP_CENTRE:
        track[t].x[1] = 257200 + grand(100000);
        break;
      }
    }
    ...
    case ENEMY_BIG4:
      ...
      track[t].x[1] = -75000;
      if (track[t].appear == AP_RIGHT ||
          (track[t].appear == AP_NONE && coin())) {
...
void set_dart_stopper(int e, int t, int m) {
  ...
  enemy[e].angle = radians_to_angle(atan2(enemy[e].y_target[0] - enemy[e].y,
...
void set_glider(int e, int t) {
  ...
  enemy[e].angle1 = radians_to_angle(atan2(enemy[e].y_target[0] - enemy[e].y,
                                           enemy[e].x_target[0] - enemy[e].x));
...
void stage_finished(void) {
  ...
  float proportion =
      ((float)arena.stage_score / (float)arena.max_stage_score) * 100;
  ...
  if (arena.level == 3) {
    ...
    // finished just means that you've finished level 3. clear means you started
    // at level 1. Finished
    //  unlocks the Chaos Squid for that difficulty level; clear gives you a
    //  'clear' sign on the level select menu.
    switch (player.type - 1) {
    case 0:
      set_config_int(diff_string, "finished0", 1);
      break;
    case 1:
      set_config_int(diff_string, "finished1", 1);
      break;
    case 2:
      set_config_int(diff_string, "finished2", 1);
      break;
    case 3:
      set_config_int(diff_string, "finished3", 1);
      break;
    case 4:
      set_config_int(diff_string, "finished4", 1);
      break;
    }
    if (arena.from_start == 1) {
      ...
      switch (player.type - 1) {
      case 0:
        set_config_int(diff_string, "clear0", 1);
        break;
      case 1:
        set_config_int(diff_string, "clear1", 1);
        break;
      case 2:
        set_config_int(diff_string, "clear2", 1);
        break;
      case 3:
        set_config_int(diff_string, "clear3", 1);
        break;
      case 4:
        set_config_int(diff_string, "clear4", 1);
        break;
      }
    }
  ...
  if (((player.wlevel[2] < player.wlevel[0]) ||
       (player.wlevel[2] == player.wlevel[0] &&
        player.wxp[2] < player.wxp[0])) &&
      ((player.wlevel[2] < player.wlevel[1]) ||
       (player.wlevel[2] == player.wlevel[1] && player.wxp[2] < player.wxp[1])))
    lowest = 2;

  options.previous_power =
      options.stage_power[player.type - 1][arena.level - 1][arena.difficulty];
  options.previous_bar =
      options
          .stage_power_bar[player.type - 1][arena.level - 1][arena.difficulty];
...
#define LEVEL_CALC3                                                            \
  ...
  options.previous_wpixels =
      ((float)(options.stage_power_bar[player.type - 1][arena.level - 1]
                                      [arena.difficulty] *
               20) /
       LEVEL_CALC3);
  ...
  if ((player.wlevel[lowest] >
       options
           .stage_power[player.type - 1][arena.level - 1][arena.difficulty]) ||
      (player.wlevel[lowest] ==
           options.stage_power[player.type - 1][arena.level - 1]
                              [arena.difficulty] &&
       player.wxp[lowest] >
           options.stage_power_bar[player.type - 1][arena.level - 1]
                                  [arena.difficulty])) {
    options.stage_power[player.type - 1][arena.level - 1][arena.difficulty] =
        player.wlevel[lowest];
    options
    ...
    set_config_int(diff_string, "power0_0",
                   options.stage_power[0][0][arena.difficulty]);
    set_config_int(diff_string, "power1_0",
                   options.stage_power[1][0][arena.difficulty]);
    set_config_int(diff_string, "power2_0",
                   options.stage_power[2][0][arena.difficulty]);
    set_config_int(diff_string, "power3_0",
                   options.stage_power[3][0][arena.difficulty]);
    set_config_int(diff_string, "power4_0",
                   options.stage_power[4][0][arena.difficulty]);

    set_config_int(diff_string, "power0_1",
                   options.stage_power[0][1][arena.difficulty]);
    set_config_int(diff_string, "power1_1",
                   options.stage_power[1][1][arena.difficulty]);
    set_config_int(diff_string, "power2_1",
                   options.stage_power[2][1][arena.difficulty]);
    set_config_int(diff_string, "power3_1",
                   options.stage_power[3][1][arena.difficulty]);
    set_config_int(diff_string, "power4_1",
                   options.stage_power[4][1][arena.difficulty]);

    set_config_int(diff_string, "power_bar0_0",
                   options.stage_power_bar[0][0][arena.difficulty]);
    set_config_int(diff_string, "power_bar1_0",
                   options.stage_power_bar[1][0][arena.difficulty]);
    set_config_int(diff_string, "power_bar2_0",
                   options.stage_power_bar[2][0][arena.difficulty]);
    set_config_int(diff_string, "power_bar3_0",
                   options.stage_power_bar[3][0][arena.difficulty]);
    set_config_int(diff_string, "power_bar4_0",
                   options.stage_power_bar[4][0][arena.difficulty]);

    set_config_int(diff_string, "power_bar0_1",
                   options.stage_power_bar[0][1][arena.difficulty]);
    set_config_int(diff_string, "power_bar1_1",
                   options.stage_power_bar[1][1][arena.difficulty]);
    set_config_int(diff_string, "power_bar2_1",
                   options.stage_power_bar[2][1][arena.difficulty]);
    set_config_int(diff_string, "power_bar3_1",
                   options.stage_power_bar[3][1][arena.difficulty]);
    set_config_int(diff_string, "power_bar4_1",
                   options.stage_power_bar[4][1][arena.difficulty]);
  }
}
